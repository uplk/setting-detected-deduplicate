...
def parse_args():
    ...
    parser.add_argument("-pro_click", action="store", dest="pro_click", required=False,
                        help="The percentage of click event", default=100)
    parser.add_argument("-pro_longclick", action="store", dest="pro_longclick", required=False,
                        help="The percentage of click event", default=10)
    ...
    parser.add_argument("-choice", action="store", dest="choice", required=False, default=0, type=int,
                        help="Run or replay")
    parser.add_argument("-emulator_path", action="store", dest="emulator_path", required=False, default="E:\\Study\\IDE\\Android\\Android-Sdk\\tools\\emulator.exe",
                        help="Emulator path")
    ...
    parser.add_argument("-root_path", action="store", dest="root_path", required=False, default="../output/",
                        help="Output path")
    parser.add_argument("-emulator_name", action="store", dest="emulator_name", required=False, default="Android8.1",
                        help="the emulator name")
    parser.add_argument("-resource_path", action="store", dest="resource_path", required=False, default="../dummy_documents/",
                        help="Resource path")
    ...
    parser.add_argument("-policy_name", action="store", dest="policy_name", required=False, default="random",
                        help="Policy name")
    parser.add_argument("-setting_random_denominator", action="store", dest="setting_random_denominator", required=False, default=10, type=int,
