...
class InjectorEmulator8_1(Injector):
    def __init__(self, devices, app, strategy_list, emulator_path, android_system, root_path, resource_path,
        ...
        super(InjectorEmulator8_1, self).__init__(devices, app, strategy_list, emulator_path, android_system, root_path, resource_path,
                 testcase_count, event_num, timeout, setting_random_denominator, rest_interval, choice)

    def change_setting_before_run(self, event_count, strategy):
        super(InjectorEmulator8_1, self).change_setting_before_run(event_count, strategy)

    def inject_setting_during_run(self, event_count, strategy, request_flag):
        super(InjectorEmulator8_1, self).inject_setting_during_run(event_count, strategy, request_flag)

    def change_setting_after_run(self, event_count, strategy):
        super(InjectorEmulator8_1, self).change_setting_after_run(event_count, strategy)

    def replay_setting(self, event, strategy_list):
        super(InjectorEmulator8_1, self).replay_setting(event, strategy_list)

    def clear_and_start_setting(self, device0, device1):
        super(InjectorEmulator8_1, self).clear_and_start_setting(device0, device1)

    def network_immediate_1(self):
        super(InjectorEmulator8_1, self).network_immediate_1()

    def network_lazy_1(self):
        super(InjectorEmulator8_1, self).network_lazy_1()

    def network_lazy_2(self):
        super(InjectorEmulator8_1, self).network_lazy_2()

    def location_lazy_1(self):
        super(InjectorEmulator8_1, self).location_lazy_1()

    def location_lazy_2(self):
        super(InjectorEmulator8_1, self).location_lazy_2()

    def display_immediate_2(self):
        super(InjectorEmulator8_1, self).display_immediate_2()

    def display_immediate_1(self):
        super(InjectorEmulator8_1, self).display_immediate_1()
